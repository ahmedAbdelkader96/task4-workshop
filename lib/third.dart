...
class Third extends StatefulWidget {
   const Third(  this.image,this.title,{super.key});
  final String image;
   final String title;
            ...
            child: Row(
              children: [
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor:Colors.blue[600],shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(15))),
                ),),
